...
program:
  ...
  talks:
    ...
    'Dia 3, Sala B, 11:00': { presenter: 'Nacles Bernardino Pirajá Gomes', advisor: 'Laís do Nascimento Salvador', topic_abbr: 'sibw', topic: 'CA: Sistemas de Informação, Banco de Dados e Web (SIBW)', title: 'Multi-MyIntegration: framework para Integração Segura de Dados Heterogêneos com GCS e Blockchain', }
