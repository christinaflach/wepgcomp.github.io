...
- A Programação Preliminar do WEPGCOMP 2024 é apresentada na [página do evento](/2024).
...
- A apresentação no WEPGCOMP não é mais _opcional_ para as/os doutorandas/os que realizaram ou realizarão o exame de qualificação (MATA34) em 2024. 
...
Faça uma cópia, renomeie para `wepgcomp24-seunome-sobrenome`, e adicione os seus slides. 
...
O nome do arquivo deve ser `wepgcomp24-seunome-sobrenome.pdf`.
...
- O WEPGCOMP 2024 será presencial.
